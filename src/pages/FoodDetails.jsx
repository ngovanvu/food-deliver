...
const FoodDetails = () => {
  ...
  // Thông tin nhưng vì chưa cài đặt hiển thị nên chỉ log ra
              ...
              {tab === "desc" ? (
                ...
                <div className="tab__form mb-3">
                  ...
                  <form className="form" onSubmit={submitHandler}>
                    ...
                    <div className="form__group">
                      <input onChange={e => setEnteredEmail(e.target.value)} required type="text" placeholder="Enter your Email" />
                    </div>
